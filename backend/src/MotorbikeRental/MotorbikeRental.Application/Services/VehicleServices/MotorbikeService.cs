...
namespace MotorbikeRental.Application.Services.VehicleServices
{
    public class MotorbikeService : IMotorbikeService
    {
        ...
        {
            var (data, total) = await unitOfWork.MotorbikeRepository.GetFilterData(
                motorbikeFilterDto.CategoryId,
                motorbikeFilterDto.Brand,
                motorbikeFilterDto.Search,
                motorbikeFilterDto.Status,
                motorbikeFilterDto.PageNumber,
                motorbikeFilterDto.PageSize,
                cancellationToken);
        ...
        public async Task<MotorbikeDto> UpdateMotorbike(MotorbikeUpdateDto motorbikeUpdateDto, CancellationToken cancellationToken = default)
        {
            ...
            Motorbike motorbike = await unitOfWork.MotorbikeRepository.GetByIdWithIncludes(motorbikeUpdateDto.MotorbikeId, cancellationToken)
            ...
            result.CategoryName = await unitOfWork.CategoryRepository.GetCategoryNameById(motorbike.CategoryId, cancellationToken)
