    ...
    <div v-else-if="contract" class="contract-detail-content">
      <div class="page-header">
        ...
        <div v-if="showActions.showAnyAction" class="header-actions">
          ...
          <button
            v-if="showActions.showSettle"
            @click="$emit('settle')"
            class="action-btn settle-btn"
            :class="{ 'incident-settle': statusInfo.isProcessingIncident }"
          >
            <i class="fas fa-handshake"></i>
            {{ statusInfo.isProcessingIncident ? 'Thanh lý (có sự cố)' : 'Thanh lý' }}
          </button>

          <button
            v-if="showActions.showPayment"
            @click="goToPayment()"
          ...
          <button
            v-if="showActions.showAddIncident"
            @click="$emit('addIncident')"
            class="action-btn incident-btn"
          >
